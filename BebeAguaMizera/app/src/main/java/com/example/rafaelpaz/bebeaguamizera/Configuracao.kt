...
class Configuracao {
    ...
    fun salvarDados(context: Context ){
        ...
        editor.putLong(CHAVE_INTERVALO, intervaloAlerta)
    ...
    fun carregarDados(context: Context ){
        ...
        intervaloAlerta = pref.getLong(CHAVE_INTERVALO, 0 )
    ...
    companion object Factory {
        fun create(): Configuracao = Configuracao()
    }
}